...
| スキル | 自律開発(全自律)、並列実装、技術負債チェック、要件定義、プロジェクト初期設定、E2Eテスト作成、E2Eテストシナリオ解説＋独立検証、E2Eテスト実行、動作確認(ウォークスルー)、PRレビュー対応、PRマージ、Conventional Commits、PRセルフレビュー、品質ゲートチェック、チケット作成 |
